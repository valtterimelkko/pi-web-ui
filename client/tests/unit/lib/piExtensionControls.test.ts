...
describe('Pi streaming steer composer', () => {
  it('enables free-text composing while streaming only for Pi SDK sessions', () => {
    ...
    // antigravity has a queue-only streaming compose path since the agy 1.1.27
    // stream-json integration (docs/plans/ANTIGRAVITY-JSON-STREAM-INTEGRATION-PLAN.md).
