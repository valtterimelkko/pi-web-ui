...
- [`VOICE-MODE-INTENT.md`](./VOICE-MODE-INTENT.md) — **Voice Mode**, the shipped two-lane voice harness: talker + confirm-gated relay, speech policy, reading levels, mobile socket durability, observability
- [`DRIVE-MODE.md`](./DRIVE-MODE.md) — Drive Mode, the distraction-reduced frontend overlay; for the voice/talker surface it hosts, read [`VOICE-MODE-INTENT.md`](./VOICE-MODE-INTENT.md)
