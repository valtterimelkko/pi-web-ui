...
### Command Code
- eligible models are what the CLI advertises minus a maintained GOAT premium exclusion list (denylist, fails open); per-model effort selectors come from a committed table regenerated by `npm run commandcode:refresh-models`
