...
- [`H3-TALKER-RETEST-RESULTS.md`](./observations/H3-TALKER-RETEST-RESULTS.md) — transient parent-facing retest results for the talker model choice (H3). Programme closed; current behaviour lives in [`docs/VOICE-MODE.md`](../VOICE-MODE.md).
...
record of what shipped is [`docs/VOICE-MODE.md`](../VOICE-MODE.md),
