...
- Pi providers in `INTERNAL_API_BLOCKED_PI_PROVIDERS` (default empty: since
  2026-09-11 both the direct `openai` provider and the OpenRouter gateway
  catalogue are intentionally served through the Internal API) are hidden from Internal API discovery and rejected again
