...
OPS=${OPS:-/root/pi-web-ui/operations/voice-relay-20260916}
SRV_UNIT=voicerelay-server
CLI_UNIT=voicerelay-client
SRV_DIR=${SRV_DIR:-/tmp/voice-relay-srv}
SRV_PORT=${SRV_PORT:-3531}
VITE_PORT=${VITE_PORT:-3532}
